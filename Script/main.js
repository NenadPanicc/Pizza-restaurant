...
var aboveLayer = document.getElementById("aboveLayer")
...
changePizza("Assets/pizza1-dark.jpg", aboveLayer)
...
// GETTING THE PICTURE WITH ZINDEX -2 TO ITS POSITIONING AND ADDING IT A SRC IMAGE
 setTimeout(() => {
  underLayer.style.top = "0"
   changePizza("Assets/pizza1.jpg", underLayer)
 },800)
 ...
 setTimeout(() => {
  ...
  // SECOND ANIMATION
  changePizza("Assets/pizza2-dark.jpg", underLayer)
  changePizza("Assets/pizza1.jpg", aboveLayer)
  ...
  setTimeout(() => {
    ...
    changePizza("Assets/pizza2.jpg", aboveLayer)
    aboveLayer.style.transitionDuration = "0s"
 ...
 introText.classList.add("fadeOut")
  introText.classList.remove("fadeIn")
 changePizza("Assets/pizza3-dark.jpg", underLayer)
 changePizza("Assets/pizza2.jpg", aboveLayer)
 // GETTING THE MAIN IMG BACK INTO POSITION
 aboveLayer.style.transitionDuration ="0s"
 aboveLayer.style.top = "0px"
 ...
 setTimeout(() => {
   underLayer.style.zIndex="-1"
   aboveLayer.style.zIndex = "-2"
   changePizza("Assets/pizza3.jpg", aboveLayer)
   aboveLayer.style.transitionDuration = "0s"
   aboveLayer.style.top = "300px"
 },1000) 
 setTimeout(() => {
